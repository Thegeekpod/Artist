...
const Artistabout = () => {
  ...
  const [clickedDataKeys, setClickedDataKeys] = useState([]);
    ...
    return (
      <form onSubmit={detailsHandleSubmit(onDetailsSubmit)}>
        ...
        <h5 className="text-left">
          Would you like your tattoo to have color or only black & grey ink?
        </h5>
        <ul>
  ...
  return (
    <>
            ...
            <div className="container">
              <div className="row row-55">
                    ...
                    <div className="img-wrap-1">
                      {user.profile_image && user.profile_image.length ? (
                        ...
                        <div className="imgbox">
                          <img
                            className="imgbo"
                            src={`https://artisttattoome.store/storage/ArtworkImage/noimg.jpg`}
                            alt={""}
                          />
                          <div className="imgtitle">
                            <h4
                              className="page-title-1 "
                              style={{ color: "white" }}
                            >
                              No Imgae
                            </h4>
                ...
                <div className="col-md-8 m-padding-0 offset-sm-top--10">
                  ...
                  <p
                    className="fst-italic h3 font-size-22 font-secondary offset-top-17 text-regular"
                    style={{ margin: "0px" }}
                  >
                    {user?.username}
                  </p>
                  ...
                  <img
                    src="/images/Screenshot-2023-09-03-160739.png"
                    style={{ width: "80%" }}
                  />
              ...
              <>
                {bannerImagedata.map((item) => (
                  <SwiperSlide key={item.id}>
                    <img
                      src={`https://artisttattoome.store/storage/BannerImage/${item.banner_image}`}
      ...
      <div className="ds section_padding_top_105 section_padding_bottom_120 parallax-block-1 parallax">
        <div className="container">
          <h3 className="page-title-1 text-center ">
            Highlights From {user?.username}
          </h3>
          <div className="row rowflex">
            <div className=" box col-sm-12 col-md-4 col-lg-4">
              <div className="text-center contitems">
                ...
                <p>
                  Each piece of art is unique, and we will quote you the best
                  price possible.
                </p>
              </div>
            </div>
            ...
            <div className=" box col-sm-12 col-md-4 col-lg-4">
              <div className="text-center contitems">
                <div className="svgicon ">
                  <svg
                    aria-hidden="true"
                    className="e-font-icon-svg e-fas-walking"
                    viewBox="0 0 320 512"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <div className=" box col-sm-12 col-md-4 col-lg-4">
              <div className="text-center contitems">
                <div className="svgicon ">
                  <svg
                    aria-hidden="true"
                    className="e-font-icon-svg e-fas-certificate"
                    viewBox="0 0 512 512"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <div className=" box col-sm-12 col-md-4 col-lg-4">
              <div className="text-center contitems">
                <div className="svgicon ">
                  <svg
                    aria-hidden="true"
                    className="e-font-icon-svg e-far-handshake"
                    viewBox="0 0 640 512"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <div className=" box col-sm-12 col-md-4 col-lg-4">
              <div className="text-center contitems">
                <div className="svgicon ">
                  <svg
                    aria-hidden="true"
                    className="e-font-icon-svg e-fas-car"
                    viewBox="0 0 512 512"
                    xmlns="http://www.w3.org/2000/svg"
                  >
        ...
        <div className="container">
          <div className="row bottommargin_40">
            <div className="col-lg-12 text-center">
              <h3 className="page-title-1">Hours Of Operation</h3>
          ...
          <div className="row vertical-tabs vertical-tabs-type-1 vertical-tabs--position">
            <div className="col-sm-12 col-md-12 col-lg-12">
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                ...
                /> */}
              <MapContainer  lat={user?.latitude || 25.1040777} lng={user.longitude || -80.4313264
}/>
            ...
            <div className=" box col-sm-12 col-md-4 col-lg-4">
              <div className="text-center contitems">
                <div className="svgicon ">
                  <svg
                    aria-hidden="true"
                    className="e-font-icon-svg e-far-snowflake"
                    viewBox="0 0 448 512"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <div className=" box col-sm-12 col-md-4 col-lg-4">
              <div className="text-center contitems">
                <div className="svgicon ">
                  <svg
                    aria-hidden="true"
                    className="e-font-icon-svg e-fas-glass-whiskey"
                    viewBox="0 0 512 512"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <div className=" box col-sm-12 col-md-4 col-lg-4">
              <div className="text-center contitems">
                <div className="svgicon ">
                  <svg
                    aria-hidden="true"
                    className="e-font-icon-svg e-fas-coffee"
                    viewBox="0 0 640 512"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <div className=" box col-sm-12 col-md-4 col-lg-4">
              <div className="text-center contitems">
                <div className="svgicon ">
                  <svg
                    aria-hidden="true"
                    className="e-font-icon-svg e-fas-biking"
                    viewBox="0 0 640 512"
                    xmlns="http://www.w3.org/2000/svg"
                  >
        ...
        <div className="container">
          <div className="row bottommargin_40">
            <div className="col-lg-12 text-center">
              ...
              <h6 className="subheader-type-1">
                Artists that use incredible techniques to design unique
                creations like glow-in-the-dark tattoos
              </h6>
            </div>
          </div>
          <div className="row text-center">
