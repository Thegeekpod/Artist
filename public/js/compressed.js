! function(e, t) {
    ...
    var ie = function(e) {
        ...
        w = t.support = {}, N = t.isXML = function(e) {
            ...
            if ((e.ownerDocument || e) !== q && L(e), n = n.replace(fe, "='$1']"), !(!w.matchesSelector || !O || P && P.test(n) || F && F.test(n))) 
...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    ...
    i.VERSION = "3.2.0", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            ...
            var l = !(null != this.unpin && o + this.unpin <= s.top) && (null != a && s.top + this.$element.height() >= e - a ? "bottom" : null != r && r >= o && "top");
            if (this.affixed !== l) {
    ...
    var o = function() {
        var o = {
            ...
            p = function(s) {
                ...
                n.length > 0 && n.is(":hidden") && (o.one("click.superfish", !1), "MSPointerDown" === s.type || "pointerdown" === s.type ? o.trigger("focus") : e.proxy(c, o.parent("li"))())
            },
            c = function() {
                var s = e(this),
                    o = m(s);
        ...
        return {
            ...
            destroy: function() {
                return this.each(function() {
                    ...
                    }), t.$path.removeClass(t.hoverClass + " " + o.bcClass).addClass(t.pathClass), n.find("." + t.hoverClass).removeClass(t.hoverClass), t.onDestroy.call(n), void n.removeData("sf-options"))
                })
            },
            init: function(s) {
                return this.each(function() {
